...
AnimusForge::Curriculum::BlockSize AnimusForge::Curriculum::ContextBlock::Size(Layout const& /*layout*/) const
{
    return { OBS_COUNT, 0 };
}

void AnimusForge::Curriculum::ContextBlock::Observe(SeatView const& view, float* obs, uint8* /*mask*/) const
{
    Player* bot = view.Bot;
