...
AnimusForge::Curriculum::BlockSize AnimusForge::Curriculum::DuelBlock::Size(Layout const& layout) const
{
...
void AnimusForge::Curriculum::DuelBlock::DescribeManifest(Layout const& layout, boost::json::object& block) const
{
    block["stable_slots"] = StableSlots(layout);
    block["stable_features"] = STABLE_FEATURES;
}

void AnimusForge::Curriculum::DuelBlock::Observe(SeatView const& view, float* obs, uint8* mask) const
{
    Player* bot = view.Bot;
    Unit* target = view.Target;
...
void AnimusForge::Curriculum::DuelBlock::ObserveDead(SeatView const& view, float* obs, uint8* mask)
{
    obs[OBS_DEAD] = 1.0f;
...
void AnimusForge::Curriculum::DuelBlock::BeforeApply(SeatView& view) const
{
...
void AnimusForge::Curriculum::DuelBlock::Apply(SeatView& view, uint32 local, SeatActionResult& result) const
{
