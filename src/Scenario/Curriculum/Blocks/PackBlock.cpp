...
AnimusForge::Curriculum::BlockSize AnimusForge::Curriculum::PackBlock::Size(Layout const& layout) const
{
...
void AnimusForge::Curriculum::PackBlock::DescribeManifest(Layout const& layout, boost::json::object& block) const
{
...
void AnimusForge::Curriculum::PackBlock::Observe(SeatView const& view, float* obs, uint8* mask) const
{
    Player* bot = view.Bot;
...
void AnimusForge::Curriculum::PackBlock::Apply(SeatView& view, uint32 local, SeatActionResult& result) const
{
