...
AnimusForge::Curriculum::BlockSize AnimusForge::Curriculum::HostilesBlock::Size(Layout const& /*layout*/) const
{
    return { PACK_SLOTS * SLOT_FEATURES, 0 };
}

void AnimusForge::Curriculum::HostilesBlock::DescribeManifest(Layout const& /*layout*/,
...
void AnimusForge::Curriculum::HostilesBlock::Observe(SeatView const& view, float* obs, uint8* /*mask*/) const
{
