...
std::string_view AnimusForge::Curriculum::BlockName(BlockId id)
{
    switch (id)
    {
...
std::optional<AnimusForge::Curriculum::BlockId> AnimusForge::Curriculum::FindBlock(std::string_view name)
{
...
AnimusForge::Curriculum::Layout AnimusForge::Curriculum::Layout::Build(ClassRoleProfile const& profile,
...
std::optional<AnimusForge::Curriculum::BlockId> AnimusForge::Curriculum::Layout::BlockOfAction(uint32 action) const
{
...
boost::json::array AnimusForge::Curriculum::SpellList(std::vector<ActionCatalog::Action> const& actions)
{
...
boost::json::array AnimusForge::Curriculum::Span(uint32 first, uint32 count)
{
    return { first, count };
}

std::string AnimusForge::Curriculum::Layout::ModelName() const
{
    return Profile->Name + Stage->Suffix;
}

std::string AnimusForge::Curriculum::Layout::Manifest() const
{
