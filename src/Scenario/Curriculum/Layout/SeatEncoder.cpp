...
void AnimusForge::Curriculum::SeatEncoder::Observe(SeatView const& view, float* obs, uint8* mask)
{
...
void AnimusForge::Curriculum::SeatEncoder::Apply(SeatView& view, int32 action, SeatActionResult& result)
{
    if (!view.Bot || !view.L)
        return;
