...
void AnimusForge::Curriculum::EnemyPlayers::MakeEnemies(Player* player, Player* enemy)
{
...
void AnimusForge::Curriculum::EnemyPlayers::Flag(Player* player)
{
    if (player && !player->IsPvP())
        player->UpdatePvP(true, true);
}

AnimusForge::Curriculum::EnemyPlayers::Spawned AnimusForge::Curriculum::EnemyPlayers::Create(BotSlot& slot,
