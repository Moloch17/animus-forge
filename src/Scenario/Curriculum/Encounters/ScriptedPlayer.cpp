...
void AnimusForge::Curriculum::ScriptedPlayer::Configure(Player* player, ClassRoleAssets const& assets, State& state,
    bool pvp)
{
...
void AnimusForge::Curriculum::ScriptedPlayer::UpdateMember(Player* member, std::vector<Player*> const& party,
...
void AnimusForge::Curriculum::ScriptedPlayer::UpdateOpponent(Player* player, Player* enemy, uint32 nowMs, State& state,
    Tuning const& tuning)
{
