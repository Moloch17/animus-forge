...
#ifndef MOD_ANIMUS_FORGE_CURRICULUM_SCRIPTED_PLAYER_H
#define MOD_ANIMUS_FORGE_CURRICULUM_SCRIPTED_PLAYER_H
 ...
 * they play is tuning (AnimusForge.Curriculum.ScriptedPlayers.*).
 */
namespace AnimusForge::Curriculum::ScriptedPlayer
{
