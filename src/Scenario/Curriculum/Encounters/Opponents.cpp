...
AnimusForge::Curriculum::Opponents::OpponentPool const& AnimusForge::Curriculum::Opponents::OpponentPool::Instance()
{
    static OpponentPool const pool;
    return pool;
}

AnimusForge::Curriculum::Opponents::OpponentPool::OpponentPool()
{
...
uint32 AnimusForge::Curriculum::Opponents::OpponentPool::PickNear(std::array<std::vector<uint32>, 81> const& byLevel,
    uint8 level)
{
...
uint32 AnimusForge::Curriculum::Opponents::OpponentPool::Random(uint8 level) const
{
    return PickNear(_byLevel, level);
}

uint32 AnimusForge::Curriculum::Opponents::OpponentPool::RandomPackMember(uint8 level) const
{
    return PickNear(_packByLevel, level);
}

uint32 AnimusForge::Curriculum::Opponents::OpponentPool::RandomElite(uint8 level) const
{
    return PickNear(_elitesByLevel, level);
}

Position AnimusForge::Curriculum::Opponents::FindSpawnPoint(Player* bot, Map* map)
{
...
Creature* AnimusForge::Curriculum::Opponents::SummonOpponent(Player* bot, Map* map, uint32 entry, Position const& pos,
    uint8 level)
{
...
Creature* AnimusForge::Curriculum::Opponents::SpawnOpponent(Player* bot, Map* map, uint32 entry)
{
    return SummonOpponent(bot, map, entry, FindSpawnPoint(bot, map), bot->GetLevel());
}

std::vector<Creature*> AnimusForge::Curriculum::Opponents::SpawnPack(Player* bot, Map* map,
