...
void AnimusForge::Curriculum::GearBuilder::BuildEnhancements(StatProfile stats)
{
...
void AnimusForge::Curriculum::GearBuilder::Enhance(Player* bot, SpecProfile const& spec) const
{
...
void AnimusForge::Curriculum::GearBuilder::EnchantItem(Player* bot, Item* item, StatProfile stats) const
{
...
void AnimusForge::Curriculum::GearBuilder::SocketItem(Player* bot, Item* item, StatProfile stats,
...
void AnimusForge::Curriculum::GearBuilder::Runeforge(Player* bot, SpecProfile const& spec) const
{
...
void AnimusForge::Curriculum::GearBuilder::ApplyPoisons(Player* bot) const
{
...
void AnimusForge::Curriculum::GearBuilder::EquipQuiver(Player* bot) const
{
