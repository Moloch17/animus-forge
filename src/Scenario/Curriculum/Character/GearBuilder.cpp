...
namespace
{
    using AnimusForge::Curriculum::StatProfile;
    using namespace AnimusForge::Curriculum::GearStats;
...
int32 AnimusForge::Curriculum::GearStats::StatPreference(StatProfile profile, uint32 stat)
{
...
namespace
{
    ...
    bool ProcSuits(AnimusForge::Curriculum::StatProfile profile, std::string_view name)
    {
        using AnimusForge::Curriculum::StatProfile;
...
AnimusForge::Curriculum::GearStats::StatVerdict AnimusForge::Curriculum::GearStats::EnchantmentVerdict(
...
AnimusForge::Curriculum::GearStats::StatVerdict AnimusForge::Curriculum::GearStats::RandomEnchantmentVerdict(
...
std::unordered_map<uint32, uint8> const& AnimusForge::Curriculum::GearStats::ItemSources()
{
...
std::unordered_set<uint32> const& AnimusForge::Curriculum::GearStats::ObtainableItems()
{
...
SpellInfo const* AnimusForge::Curriculum::GearStats::ItemUseSpell(ItemTemplate const* proto)
{
    if (!proto)
        return nullptr;
...
AnimusForge::Curriculum::GearBuilder::GearBuilder(ClassRoleProfile const& profile, ClassKit const& kit)
...
void AnimusForge::Curriculum::GearBuilder::BuildPools(StatProfile stats)
{
...
std::vector<AnimusForge::Curriculum::GearBuilder::Candidate const*> AnimusForge::Curriculum::GearBuilder::Window(
...
bool AnimusForge::Curriculum::GearBuilder::EquipFromPool(Player* bot, uint8 slot, Pool pool, StatProfile stats,
...
void AnimusForge::Curriculum::GearBuilder::LearnProficiencies(Player* bot)
{
    for (uint32 i = 0; i < sSkillLineStore.GetNumRows(); ++i)
    {
        SkillLineEntry const* line = sSkillLineStore.LookupEntry(i);
...
bool AnimusForge::Curriculum::GearBuilder::EquipWeapons(Player* bot, SpecProfile const& spec, WeaponLayout layout,
    bool pvp) const
{
...
void AnimusForge::Curriculum::GearBuilder::Equip(Player* bot, SpecProfile const& spec, bool pvp) const
{
...
void AnimusForge::Curriculum::GearBuilder::StoreAmmo(Player* bot) const
{
