...
namespace
{
    using AnimusForge::Curriculum::RangeBand;
    using AnimusForge::Curriculum::Role;
    using AnimusForge::Curriculum::SpecProfile;
    using AnimusForge::Curriculum::StatProfile;
    using AnimusForge::Curriculum::WeaponLayout;
...
char const* AnimusForge::Curriculum::RoleName(Role role)
{
    switch (role)
    {
...
AnimusForge::Curriculum::Role AnimusForge::Curriculum::RollRole(int32 tankChance, int32 healerChance)
{
    int32 const roll = irand(0, 99);
    return roll < tankChance ? Role::Tank : roll < tankChance + healerChance ? Role::Heal : Role::Dps;
}

float AnimusForge::Curriculum::DamageScale(uint8 level)
{
    return 15.0f * std::exp(0.068f * float(level));
}

std::vector<AnimusForge::Curriculum::ClassRoleProfile> const& AnimusForge::Curriculum::ClassRoleProfiles()
{
