...
namespace
{
    ...
    struct ClassAssets
    {
        std::unique_ptr<AnimusForge::Curriculum::ClassKit> Kit;
        std::unique_ptr<AnimusForge::Curriculum::TalentBuilder> Talents;
        std::unique_ptr<AnimusForge::Curriculum::ActionCatalog> Catalog;
    };
}

AnimusForge::Curriculum::ClassRoleAssets const& AnimusForge::Curriculum::ClassRoleAssets::For(
...
AnimusForge::Curriculum::ClassRoleProfile const* AnimusForge::Curriculum::ClassRoleAssets::FindProfile(
...
std::vector<uint8> AnimusForge::Curriculum::ClassRoleAssets::ClassesForRole(uint8 level, Role role)
{
