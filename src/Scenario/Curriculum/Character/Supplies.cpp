...
namespace
{
    ...
    bool BuffSuits(SpellInfo const* info, AnimusForge::Curriculum::StatProfile stats)
    {
...
AnimusForge::Curriculum::ConsumablePool const& AnimusForge::Curriculum::ConsumablePool::Instance()
{
    static ConsumablePool const pool;
    return pool;
}

AnimusForge::Curriculum::ConsumablePool::ConsumablePool()
{
...
AnimusForge::Curriculum::BattleSupplies AnimusForge::Curriculum::ConsumablePool::Supplies(uint8 level, bool usesMana,
...
uint32 AnimusForge::Curriculum::ConsumablePool::BuffSpell(uint8 level, StatProfile stats) const
{
...
uint16 AnimusForge::Curriculum::ConsumablePool::FirstAidSkill(uint8 level)
{
...
uint32 AnimusForge::Curriculum::ConsumablePool::Best(std::vector<std::pair<uint8, uint32>> const& items, uint8 level)
{
    uint32 best = 0;
...
AnimusForge::Curriculum::StablePool const& AnimusForge::Curriculum::StablePool::Instance()
{
    static StablePool const pool;
    return pool;
}

AnimusForge::Curriculum::StablePool::StablePool()
{
...
void AnimusForge::Curriculum::StockConsumables(Player* bot, uint32 food, uint32 drink)
{
...
bool AnimusForge::Curriculum::CallHunterBeast(Player* bot, uint32 entry)
{
