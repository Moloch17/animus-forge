...
AnimusForge::Curriculum::TalentBuilder::TalentBuilder(uint8 playerClass)
{
...
bool AnimusForge::Curriculum::TalentBuilder::CanTake(Build const& build, uint32 index) const
{
...
AnimusForge::Curriculum::TalentBuilder::Build AnimusForge::Curriculum::TalentBuilder::Standard(std::string const& spec,
...
void AnimusForge::Curriculum::TalentBuilder::ApplyGlyphs(Player* bot, std::string const& spec) const
{
    auto const data = _specs.find(spec);
    if (data == _specs.end())
        return;
...
AnimusForge::Curriculum::TalentBuilder::Build AnimusForge::Curriculum::TalentBuilder::Random(uint8 specTab,
    uint32 points) const
{
    Build build;
    build.Ranks.assign(_talents.size(), 0);
...
void AnimusForge::Curriculum::TalentBuilder::Spend(Build& build, uint32 treeMask, uint32 points) const
{
...
uint32 AnimusForge::Curriculum::TalentBuilder::Apply(Player* bot, Build const& build) const
{
