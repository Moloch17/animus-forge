...
#ifndef MOD_ANIMUS_FORGE_CLASS_ROLE_OPPONENTS_H
#define MOD_ANIMUS_FORGE_CLASS_ROLE_OPPONENTS_H
...
/*
 * Hostile creatures for the class/role stages: the pools they are drawn from, where they spawn, and summoning them.
 */
namespace AnimusForge::ClassRole::Opponents
{
