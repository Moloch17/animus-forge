...
#ifndef MOD_ANIMUS_FORGE_CLASS_ROLE_TUNING_H
...
/*
 * Every value that shapes what the class/role curriculum trains on and what it is paid for: the characters, parties,
 * pulls and scripted players it meets, and the reward weights. Each is the config key AnimusForge.ClassRole.<key>
...
namespace AnimusForge::ClassRole
{
    struct ClassRoleTuning
    {
        ...
        /// Calls f(key, value) for every value, key relative to AnimusForge.ClassRole.
        ...
        /// The values from the config, each defaulting to the value above; min/max pairs are ordered.
