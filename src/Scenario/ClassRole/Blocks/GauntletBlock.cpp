...
AnimusForge::ClassRole::BlockSize AnimusForge::ClassRole::GauntletBlock::Size(Layout const& layout) const
{
...
void AnimusForge::ClassRole::GauntletBlock::Apply(SeatView& view, uint32 local, SeatActionResult& result) const
{
