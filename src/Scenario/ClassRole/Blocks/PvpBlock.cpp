...
AnimusForge::ClassRole::BlockSize AnimusForge::ClassRole::PvpBlock::Size(Layout const& /*layout*/) const
{
    return { OBS_COUNT, 0 };
}

void AnimusForge::ClassRole::PvpBlock::Observe(SeatView const& view, float* obs, uint8* /*mask*/) const
{
    Player* bot = view.Bot;
