...
namespace
{
    ...
    struct ClassAssets
    {
        std::unique_ptr<AnimusForge::ClassRole::ClassKit> Kit;
        std::unique_ptr<AnimusForge::ClassRole::TalentBuilder> Talents;
        std::unique_ptr<AnimusForge::ClassRole::ActionCatalog> Catalog;
    };
}

AnimusForge::ClassRole::ClassRoleAssets const& AnimusForge::ClassRole::ClassRoleAssets::For(ClassRoleProfile const& profile)
{
...
AnimusForge::ClassRole::ClassRoleProfile const* AnimusForge::ClassRole::ClassRoleAssets::FindProfile(uint8 playerClass, Role role)
{
