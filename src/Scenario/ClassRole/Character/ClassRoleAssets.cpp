...
AnimusForge::ClassRole::ClassRoleAssets const& AnimusForge::ClassRole::ClassRoleAssets::For(
...
AnimusForge::ClassRole::ClassRoleProfile const* AnimusForge::ClassRole::ClassRoleAssets::FindProfile(uint8 playerClass,
    Role role)
{
