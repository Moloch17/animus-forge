...
std::unordered_set<uint32> const& AnimusForge::ClassRole::WorldCreatures::SpawnedIds()
{
    static std::unordered_set<uint32> const ids = QueryIds("SELECT DISTINCT id FROM creature");
    return ids;
}

std::unordered_set<uint32> const& AnimusForge::ClassRole::WorldCreatures::WaypointWalkerIds()
{
