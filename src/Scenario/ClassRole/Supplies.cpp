...
namespace
{
    ...
    bool BuffSuits(SpellInfo const* info, AnimusForge::ClassRole::StatProfile stats)
    {
...
AnimusForge::ClassRole::BattleSupplies AnimusForge::ClassRole::ConsumablePool::Supplies(uint8 level, bool usesMana,
...
uint32 AnimusForge::ClassRole::ConsumablePool::BuffSpell(uint8 level, StatProfile stats) const
{
...
uint16 AnimusForge::ClassRole::ConsumablePool::FirstAidSkill(uint8 level)
{
...
void AnimusForge::ClassRole::StockBattleSupplies(Player* bot, BattleSupplies const& supplies, StatProfile stats)
{
    ...
    stock(supplies.HealthPotion, LayoutConstants::CONSUMABLE_COUNT);
    stock(supplies.ManaPotion, LayoutConstants::CONSUMABLE_COUNT);
    ...
    if (supplies.Bandage)
    {
        ...
        stock(supplies.Bandage, LayoutConstants::CONSUMABLE_COUNT);
    }
