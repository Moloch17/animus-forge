...
AnimusForge::ClassKit::ClassKit(uint8 playerClass) : _class(playerClass)
{
    std::set<uint32> seen;
...
uint8 AnimusForge::ClassKit::MinLevel() const
{
    return _class == CLASS_DEATH_KNIGHT ? DEATH_KNIGHT_START_LEVEL : 1;
}

void AnimusForge::ClassKit::Learn(Player* bot) const
{
