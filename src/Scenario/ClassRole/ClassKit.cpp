...
AnimusForge::ClassRole::ClassKit::ClassKit(uint8 playerClass) : _class(playerClass)
{
    std::set<uint32> seen;
...
void AnimusForge::ClassRole::ClassKit::StoreReagents(Player* bot) const
{
...
uint32 AnimusForge::ClassRole::ClassKit::ArmorSubclass(uint8 level) const
{
    switch (_class)
    {
        case CLASS_WARRIOR:
