...
void AnimusForge::ClassRole::GearBuilder::BuildEnhancements(StatProfile stats)
{
...
void AnimusForge::ClassRole::GearBuilder::Enhance(Player* bot, SpecProfile const& spec) const
{
...
void AnimusForge::ClassRole::GearBuilder::EnchantItem(Player* bot, Item* item, StatProfile stats) const
{
...
void AnimusForge::ClassRole::GearBuilder::SocketItem(Player* bot, Item* item, StatProfile stats,
...
void AnimusForge::ClassRole::GearBuilder::Runeforge(Player* bot, SpecProfile const& spec) const
{
...
void AnimusForge::ClassRole::GearBuilder::ApplyPoisons(Player* bot) const
{
...
void AnimusForge::ClassRole::GearBuilder::EquipQuiver(Player* bot) const
{
