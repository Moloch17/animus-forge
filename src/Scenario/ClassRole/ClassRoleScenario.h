...
namespace AnimusForge::ClassRole
{
    ...
    public:
        ...
        ClassRoleScenario(ForgeConfig const& config, StageDefinition const& stage);
        ...
        [[nodiscard]] ClassRoleTuning const& Tuning() const { return _tuning; }
