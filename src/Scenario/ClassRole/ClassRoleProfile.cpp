...
namespace
{
    using AnimusForge::RangeBand;
    using AnimusForge::Role;
    using AnimusForge::SpecProfile;
    using AnimusForge::StatProfile;
    using AnimusForge::WeaponLayout;
...
char const* AnimusForge::RoleName(Role role)
{
    switch (role)
    {
...
std::vector<AnimusForge::ClassRoleProfile> const& AnimusForge::ClassRoleProfiles()
{
