...
from animus.runs import ARCHIVE_DIR, LATEST_CHECKPOINT, archive_run, resume_checkpoint_path, resume_mismatch
...
def spec_dict(**changes) -> dict:
    spec = {
        ...
        "episode_info_dim": 3, "tick_ms": 50, "decision_ticks": 2, "episode_seconds": 60, "scenario": "class_role",
